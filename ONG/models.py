...
class EMAIL_DAS_ONGS(models.Model):
    ...
    emo_email = models.CharField(verbose_name="Email", max_length=40)
...
class TEL_DAS_ONGS(models.Model):
    ton_id = models.AutoField(primary_key=True)
    ton_telefone = models.CharField(verbose_name="Telefone", max_length=15)
